...
[
  intrinsicMatrix1, distortionCoefficients1, intrinsicMatrix2, ... distortionCoefficients2,
  rotationOfCamera2,
...
% Width is the second element imageHeight = imageSize(1);
...
% Create the transformation matrix T_c1_c2 = eye(4);
% Initialize as identity matrix T_c1_c2(1 : 3, 1 : 3) = rotationOfCamera2;
% Assign rotation T_c1_c2(1 : 3, 4) = translationOfCamera2;
% Assign translation

    % Print the transformation matrix to the file fprintf(fileID,
...
if j
  < size(T_c1_c2, 2) fprintf(fileID, ', ');
end end if i < size(T_c1_c2, 1) fprintf(fileID, ',\n         ');
else fprintf(fileID, ']\n');
end end
