...
void MonocularSlamNode::GrabImage(const ImageMsg::SharedPtr msg) {
  ...
  if (cropping_x != -1)
    Utility::cropping_image(image_for_orbslam, cropping_rect);
...
cv::Scalar MonocularSlamNode::interpolateColor(float value, float minDepth,
                                               float maxDepth) {
  // Doesn't working
...
sensor_msgs::msg::PointCloud2 MonocularSlamNode::mappoint_to_pointcloud(
